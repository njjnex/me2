		...
		<div class="row">
			<div class="col-sm-3">
				...
				<img title="profile image" class="img-rounded img-responsive"
					src="${pageContext.request.contextPath}/resources/images/avatars/${user.id}.jpg" onerror="if (this.src != '${user.id}.jpg') this.src = '${pageContext.request.contextPath}/resources/images/avatars/template.png';"
